...
const qualificationData = [
  {
    ...
    data: [
      {
        university: "Phonics Group of Institution Roorkee",
  ...
  },
  {
    ...
    data: [
      ...
      {
        company: "Owebest Technologies Private Limited Jaipur",
        role: "Python Developer",
        years: "2021 - 2022",
      },
    ],
                            ...
                            (item, index) => {
                              ...
                              return (
                                <div className="flex gap-x-8 group" key={index}>
                                  ...
                                  <div>
                                    <div className="font-semibold text-xl leadig-none mb-2">
                                      {company}
                                    </div>
